...
/usr/bin/time --verbose matlab -nosplash -nodesktop -nodisplay -r "cd('~/Scratch/2020_RiskyReplay/scripts'); build_classifier('/lustre/scratch/scratch/skgtjm6/2020_RiskyReplay/scripts/680913/680913_t200_n1.mat')"
