...
/usr/bin/time --verbose matlab -nosplash -nodesktop -nodisplay -r "cd('~/Scratch/2020_RiskyReplay/scripts'); build_classifier('/lustre/scratch/scratch/skgtjm6/2020_RiskyReplay/scripts/795776/795776_t10_n1.mat')"
