...
/usr/bin/time --verbose matlab -nosplash -nodesktop -nodisplay -r "cd('~/Scratch/2020_RiskyReplay/scripts'); build_classifier('/lustre/scratch/scratch/skgtjm6/2020_RiskyReplay/scripts/147947/147947_t280_n1.mat')"
