function [transitioned, state2] = state_transition(action,state1,transitions,health,this_day,params,show_action)
...
% show_action = 1 to show the action name (e.g. >> LEFT >>), 0 to hide
...
character_img = params.character_img;
